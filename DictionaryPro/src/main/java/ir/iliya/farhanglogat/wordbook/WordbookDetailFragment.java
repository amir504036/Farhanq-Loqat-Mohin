package ir.iliya.farhanglogat.wordbook;
...
import ir.iliya.farhanglogat.AbstractDetailFragment;
import ir.iliya.farhanglogat.R;
import ir.iliya.farhanglogat.LangTextView;
import ir.iliya.farhanglogat.SoundPlayer;
import ir.iliya.farhanglogat.data.appdata.AppDataContract;
import ir.iliya.farhanglogat.data.wordbook.WordbookContract;
import ir.iliya.farhanglogat.data.wordbook.WordbookEntry;
import ir.iliya.farhanglogat.data.wordbook.WordbookXmlParser;
...
/**
 * A {@link AbstractDetailFragment} used to display a wordbook entry.
 */
public class WordbookDetailFragment extends AbstractDetailFragment {

    public static final String TAG = "WordbookDetailFragment";
    public static final String VIEWONWEB_TOOL_EXTRA_KEY = "ir.iliya.farhanglogat.wordbook.ViewonwebToolExtraKey";
